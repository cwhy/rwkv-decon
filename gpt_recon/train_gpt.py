...
import nlp_utils
from gpt_recon.clean_frame import batch_fy, Linear
from gpt_recon.clean_frame_utils import Arr, init_weight_module
...
model = gpt_config_.make()
loss_f = partial(gpt_loss_batch, model.f)
...
for step in range(max_iters):
    ...
    if step % eval_interval == 0:
        ...
        generate_f = partial(model.f, train_state_.weights)
